...
namespace SidebarDiagnostics.Models
{
    public class GraphModel : INotifyPropertyChanged, IDisposable
    {
        public GraphModel()
        {
            ...
            _plotModel.Axes.Add(new LogarithmicAxis() { Position = AxisPosition.Left, MajorGridlineStyle = LineStyle.Solid });
            _plotModel.Axes.Add(new DateTimeAxis() { Position = AxisPosition.Bottom, StringFormat = "T", Angle = 45 });
        }
