...
namespace SidebarDiagnostics.Framework
{
    ...
    public sealed class Settings : INotifyPropertyChanged
    {
        ...
        private bool _floatingBarEnabled { get; set; } = false;

        [JsonProperty]
        public bool FloatingBarEnabled
        {
            get
            {
                return _floatingBarEnabled;
            }
            set
            {
                _floatingBarEnabled = value;

                NotifyPropertyChanged("FloatingBarEnabled");
            }
        }

        private double _floatingBarX { get; set; } = 100d;

        [JsonProperty]
        public double FloatingBarX
        {
            get
            {
                return _floatingBarX;
            }
            set
            {
                _floatingBarX = value;

                NotifyPropertyChanged("FloatingBarX");
            }
        }

        private double _floatingBarY { get; set; } = 100d;

        [JsonProperty]
        public double FloatingBarY
        {
            get
            {
                return _floatingBarY;
            }
            set
            {
                _floatingBarY = value;

                NotifyPropertyChanged("FloatingBarY");
            }
        }

        private bool _floatingBarAlwaysOnTop { get; set; } = true;
        ...
        private double _floatingBarOpacity { get; set; } = 0.9d;
