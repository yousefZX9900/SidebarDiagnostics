...
namespace SidebarDiagnostics
{
    ...
    public partial class App : Application
    {
        ...
        private const string MutexName = "SidebarDiagnostics_SingleInstance_Mutex";
        ...
        private static void BringExistingInstanceToFront()
        {
            try
            {
                ...
                foreach (var process in processes)
                {
                    ...
                    {
                        // Bring the window to front using Windows API
        ...
        public static void StartApp(bool openSettings)
        {
            ...
            if (Framework.Settings.Instance.DockEdge == DockEdge.Floating)
            {
        ...
        public void OpenSettings()
        {
            ...
            // Check if we're in floating bar mode
            if (Framework.Settings.Instance.DockEdge == DockEdge.Floating)
            {
                FloatingBar _floatingBar = FloatingBar;
                if (_floatingBar != null)
                {
                    new Settings(_floatingBar);
                }
                return;
            }
        ...
        public void OpenGraph()
        {
            ...
            // For FloatingBar mode, graph is not fully supported yet
        ...
        {
            SidebarDiagnostics.Windows.Monitor _primary = SidebarDiagnostics.Windows.Monitor.GetMonitors().GetPrimary();
        ...
        private void Visibility_SubmenuOpened(object sender, EventArgs e)
        {
            ...
            if (_floatingBar != null)
            {
                (_this.Items.GetItemAt(0) as MenuItem).IsChecked = _floatingBar.Visibility == Visibility.Visible;
                (_this.Items.GetItemAt(1) as MenuItem).IsChecked = _floatingBar.Visibility == Visibility.Hidden;
            }
        }
        ...
        private void Show_Click(object sender, EventArgs e)
        {
            ...
            // Check for FloatingBar
            FloatingBar _floatingBar = FloatingBar;
            if (_floatingBar != null && _floatingBar.Visibility != Visibility.Visible)
            {
                _floatingBar.Show();
            }
        }
        ...
        private void Hide_Click(object sender, EventArgs e)
        {
            ...
            if (_sidebar != null)
            {
                if (_sidebar.Visibility == Visibility.Hidden)
                    return;
                _sidebar.AppBarHide();
                return;
            }
            ...
            // Check for FloatingBar
            FloatingBar _floatingBar = FloatingBar;
            if (_floatingBar != null && _floatingBar.Visibility != Visibility.Hidden)
            {
                _floatingBar.Hide();
            }
        }
        ...
        public FloatingBar FloatingBar
        {
            get
            {
                return Windows.OfType<FloatingBar>().FirstOrDefault();
            }
        }
